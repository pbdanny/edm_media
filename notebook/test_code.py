...
cmp.target_store_file

# COMMAND ----------

new_target_store_file = DBPath("/dbfs/FileStore/media/campaign_eval/01_hde/00_cmp_inputs/inputs_files/target_store_2023_0019_M01E_test.csv")

cmp.target_store_file = new_target_store_file
...
# DBTITLE 1,Dev code
x, y, z = get_cust_activated_by_mech_dev(cmp)
