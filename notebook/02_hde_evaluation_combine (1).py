...
print('cmp.mv_week_type = ' + str(cmp.mv_week_type) )

if cmp.params["wk_type"] == "fis_wk":
    cmp.mv_week_type = "fis_week"
elif cmp.params["wk_type"] == "promo_wk":
    cmp.mv_week_type = "promo_week"
...
pandas_to_csv_filestore(uplift_feature_df, 'customer_uplift_sku_by_mech.csv', prefix=os.path.join(eval_path_fl, cmp_month, cmp_nm, 'result'))
